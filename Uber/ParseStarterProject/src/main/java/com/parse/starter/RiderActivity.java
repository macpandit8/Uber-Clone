...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    // HANDLER TO CHECK DRIVER'S LOCATION EVERY FEW SECONDS AND CHECK WHETHER DRIVER REACHED RIDER
    ...
    // A METHOD TO CHECK FEW THINGS 1)DID SOMEONE PICKED UP THE REQUEST, 2)
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                ...
                if (e == null && objects.size() > 0) {
                    ...
                    ParseQuery<ParseUser> query = ParseUser.getQuery();             // TO FIND OUT LOCATION OF THE DRIVER
                    query.whereEqualTo("username", objects.get(0).getString("driverUsername")); // AND UPDATE THE MAP
                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if(distanceInMiles < 0.01) {
                                            ...
                                            final ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Request"); // TO DELETE ACTIVE REQUESTS BY USER
                                            ...
                                            // NOW WE WANT TO SHOW DRIVER'S LOCATION MARKER ON THE MAP
